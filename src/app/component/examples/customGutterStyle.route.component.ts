...
@Component({
    ...
    styles: [`
        :host as-split ::ng-deep .as-split-gutter {
            background-color: yellow !important;
            cursor: grab !important;
        }
        :host as-split.is-horizontal ::ng-deep .as-split-gutter {
        ...
        :host as-split.is-vertical ::ng-deep .as-split-gutter {
    ...
    template: `
        ...
        <div class="container">
            ...
            <div class="split-example">
                <as-split [direction]="direction" gutterSize="30">
