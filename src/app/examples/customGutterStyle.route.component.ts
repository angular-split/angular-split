...
@Component({
  ...
  template: `
    <div class="container">
        <h4>Split with custom gutter style</h4>
        <div class="split-example">
            <split [direction]="dir" gutterSize="30" gutterColor="yellow" [gutterImageH]="customImageH" [gutterImageV]="customImageV">
                <split-area [size]="30">
        ...
        <br>
        <button (click)="dir = (dir === 'horizontal') ? 'vertical' : 'horizontal'">Toggle direction</button>
        <br><br>
        <pre [innerText]="code"></pre>
    </div>`
})
export class CustomGutterStyleComponent {
    dir = 'horizontal';
