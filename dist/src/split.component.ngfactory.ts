...
import * as import18 from './splitGutter.directive.ngfactory';
import * as import19 from '../../src/splitGutter.directive';
...
class View_SplitComponent2 extends import2.AppView<any> {
  _el_0:any;
  _SplitGutterDirective_0_3:import18.Wrapper_SplitGutterDirective;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import11.ViewContainer) {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._SplitGutterDirective_0_3 = new import18.Wrapper_SplitGutterDirective(new import10.ElementRef(this._el_0),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import19.SplitGutterDirective) && (0 === requestNodeIndex))) { return this._SplitGutterDirective_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
