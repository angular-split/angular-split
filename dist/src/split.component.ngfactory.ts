...
class View_SplitComponent1 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_1_0_0:any = (((this.context.last === false) && (this.context.$implicit.component.visible === true)) && (this.parentView.context.areas[(this.context.index + 1)].component.visible === true));
