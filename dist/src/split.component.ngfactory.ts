...
export class Wrapper_SplitComponent {
  ...
  check_visibleTransition(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_5,currValue))) {
      this._changed = true;
      this.context.visibleTransition = currValue;
      this._changes['visibleTransition'] = new import1.SimpleChange(this._expr_5,currValue);
  ...
  checkHost(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any,throwOnChange:boolean):void {
    ...
    if (import3.checkBinding(throwOnChange,this._expr_8,currVal_8)) {
      view.renderer.setElementClass(el,'notransition',currVal_8);
